...
- **Topic-switch (отравление)** — резкая смена тематики (пекарня → казино = poisoned history).
...
скачать «сырой» HTML (`id_`) → прогнать по ключевикам/классификатору → выставить флаги и детект свитча.
...
6. **Topic-switch:** сравнить тематику ранних vs поздних снапшотов (напр. эмбеддинги/категории).
   Резкий разрыв (легитимная тема → gambling/adult) → флаг `topic_switch`, штраф в скоре.
